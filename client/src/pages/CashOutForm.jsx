...
const CashOutForm = () => {
    ...
    const handleCashOut = async (e) => {
        ...
        try {
            const response = await axiosPublic.post('/cashOut', { 
                amount, 
                pin, 
                phone: user?.phone,
                name: user?.name 
        ...
        <section className="dark:bg-gray-900">
            <div className="flex justify-center items-center min-h-screen">
                <div className="bg-gray-200 flex items-center w-full max-w-2xl p-8 mx-auto lg:px-12 lg:w-3/5">
                    <form onSubmit={handleCashOut} className="w-full py-20">
                        ...
                        <div>
                            <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input name="amount" type="number" placeholder="Amount to cash out" value={amount} onChange={(e) => setAmount(e.target.value)} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" required />
                                </div>

                                <div>
                                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">PIN</label>
                                    <input name="pin" type="password" placeholder="Your PIN" onChange={(e) => setPin(e.target.value)} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" required />
                                </div>
                            </div>
