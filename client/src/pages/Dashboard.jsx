...
const Dashboard = () => {
    ...
    return (
        <div className="flex">
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6">
                        <nav className="flex-1 -mx-3 space-y-3 ">
                            ...
                            <p className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" >
                                ...
                                <span className="mx-2 text-sm font-medium">{user?.phone}</span>
                                <span className="mx-2 text-sm font-medium">{user?.balance}</span>
                            </p>

                            {/* balanceRequest agent*/}

                            <Link to="/balanceRequest">
                                <p className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" >
                                    ...
                                    <span className="mx-2 text-sm font-medium">All Balance Request</span>
                                </p>
                            </Link>
                            {/*all user list admin */}
                            ...
                            <Link to="/allUserList">
                                <p className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" >
                                    ...
                                    <span className="mx-2 text-sm font-medium">User list and Agent</span>
                                </p>
                            </Link>
                            {/* cash out */}
                            ...
                            <Link to="register">
                                <p className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                    ...
                                    <span className="mx-2 text-sm font-medium">Register</span>
                                </p>
                            </Link>
                        </nav>

                        <div className="mt-2 border-2 border-red-600">
            ...
            {/* content */}
            <div className="flex-1 border-2 border-green-600 bg-gray-200">
                <Outlet />
            </div>
        </div>
    );
